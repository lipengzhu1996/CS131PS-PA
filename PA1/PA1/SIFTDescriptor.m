...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        feature = [];
        for ii=1:num_histograms
            for jj=1:num_histograms
                patch_mag_l=patch_mag((ii-1)*num_histograms+1:ii*num_histograms,(jj-1)*num_histograms+1:jj*num_histograms);
                patch_theta_l=patch_theta((ii-1)*num_histograms+1:ii*num_histograms,(jj-1)*num_histograms+1:jj*num_histograms);
                [histogram,~] = ComputeGradientHistogram(num_angles,patch_mag_l,patch_theta_l);
                feature=[feature, histogram];
            end
        end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:size(gradient_magnitudes,1)
        for j=1:size(gradient_magnitudes,1)
            k=uint8(floor(gradient_angles(i,j)/angle_step));
            histogram(k+1)=histogram(k+1)+gradient_magnitudes(i,j);  
        end
    end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [max_val,bins] = max(histogram);
    direction = angles(bins);
